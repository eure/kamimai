...
func TestInt(t *testing.T) {
	...
	candidates := []struct {
		...
		{value: int8(1), expected: 1, message: ""},
		{value: int16(1), expected: 1, message: ""},
		{value: int32(1), expected: 1, message: ""},
		{value: int64(1), expected: 1, message: ""},
		{value: uint8(1), expected: 1, message: ""},
		{value: uint16(1), expected: 1, message: ""},
		{value: uint32(1), expected: 1, message: ""},
		{value: uint64(1), expected: 1, message: ""},
